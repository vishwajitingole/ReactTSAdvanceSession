...
function ProductCard({product,handleAdd,index}){

   let {image,title,price}=product;

    return (
    <div className="bg-stone-200 rounded-lg w-[20rem] h-[25rem] text-center overflow-hidden">
       <div className="flex justify-center items-center">
        ...
        <motion.button 
            ...
            whileTap={{ scale: 0.9 }} 
            animate={{ scale: 1 }}  
            className="px-3 py-1 bg-orange-400 rounded-lg "
        >  
            Add to Cart 
        </motion.button>
    </div>)
